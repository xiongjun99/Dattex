 ...
 * Time: 下午 4:24
 */
public class FleXoPopWindow implements PopupWindow.OnDismissListener{
     ...
     */
    private boolean enableOutsideTouchDisMiss = false;// 默认点击pop之外的地方可以关闭

    private FleXoPopWindow(Context context){
        mContext = context;
    }
     ...
     * @return
     */
    public FleXoPopWindow showAsDropDown(View anchor, int xOff, int yOff){
    ...
    public FleXoPopWindow showAsDropDown(View anchor){
        if(mPopupWindow!=null){
    ...
    public FleXoPopWindow showAsDropDown(View anchor, int xOff, int yOff, int gravity){
        if(mPopupWindow!=null){
     ...
     * @return
     */
    public FleXoPopWindow showAtLocation(View parent, int gravity, int x, int y){
        if(mPopupWindow!=null){
        ...
        if(!enableOutsideTouchDisMiss){
            ...
            mPopupWindow.setTouchInterceptor((v, event) -> {
                ...
                if ((event.getAction() == MotionEvent.ACTION_DOWN)
                    ...
                    LogUtil.e("out side ");
                    LogUtil.e("width:"+mPopupWindow.getWidth()+"height:"+mPopupWindow.getHeight()+" x:"+x+" y  :"+y);
                    return true;
    ...
    public static class PopupWindowBuilder{
        private FleXoPopWindow mCustomPopWindow;

        public PopupWindowBuilder(Context context){
            mCustomPopWindow = new FleXoPopWindow(context);
        }

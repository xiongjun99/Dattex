...
public class SeekbarWithIntervals extends LinearLayout {
    ...
    private int getSeekbarThumbWidth() {
        return getResources().getDimensionPixelOffset(R.dimen.chart_bottom_padding);
    }
    ...
    private SeekBar getSeekbar() {
        if (Seekbar == null) {
            ...
            Seekbar.getThumb().setColorFilter(getResources().getColor(R.color.color_FF47BAFC), PorterDuff.Mode.SRC_ATOP);//设置滑块颜色、样式
